package Tests.Register.Cases.Retesting;
...
public class TestEmailInvalidDomain {
    ...
    public void validCredentials() throws InterruptedException {
        ...
        inputField.sendKeys(RandomStringUtils.randomAlphabetic(10)+"@gmail");
        ...
        WebElement formTwo = wait.until(ExpectedConditions.presenceOfElementLocated(By.id(rv.getFormTwoId())));

        Thread.sleep(250);

        Assert.assertTrue(!formTwo.isDisplayed());
